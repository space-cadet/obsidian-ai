...
### T4 — Streaming *(requires T9)*
Vercel AI SDK streaming for chat panel. Provider layer complete; chat-panel UI wiring remains. See `tasks/T4.md`.
...
*None cancelled. T10, T11, T12 are paused until T4 streaming UI work completes.*
