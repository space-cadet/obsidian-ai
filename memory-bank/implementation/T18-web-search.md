...
Three search providers are supported, user-selectable in Settings:
...
- Dropdown with 3 options (labeled with "free/requires key/self-hosted")
- Conditional Brave API key field (password input type)
- Conditional SearXNG URL field
